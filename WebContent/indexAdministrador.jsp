            ...
            <div class="row">
                ...
                <div class="col-sm-4 portfolio-item">
                    <a href="crearArea.jsp" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x">Docente</i>
                            </div>
                        </div>
                        <img src="http://2.bp.blogspot.com/-zTfSAI7ENcs/U3V4Ik7R1kI/AAAAAAAACaI/WsEcJLrtBgY/s1600/4953193.gif" class="img-responsive" alt="">
                    </a>
                </div>
