                    ...
                    <a href="crearEstudiante.jsp" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x">Calificaciones</i>
                            </div>
                        </div>
                        <img src="http://3.bp.blogspot.com/-hlWQaiEhqsM/UWZ5As8oYcI/AAAAAAAAArc/CPOPIxHjiuY/s1600/GIFS_-_EINSTEN.gif" class="img-responsive" alt="">
                    </a>
                </div>
                
                <div class="col-sm-4 portfolio-item">
                    <a href="crearObservacion.jsp" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>LOGOS es una aplicación que permite la gestión de notas</p>
                </div>
            </div>
        </div>
    </section>
